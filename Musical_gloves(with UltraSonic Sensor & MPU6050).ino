...
int calculate_distance() //ultrasonic distance in CM
{
...
//  getSensorData();
  ...
  int UsensorDist = calculate_distance();
  
  if (UsensorDist < 41 && UsensorDist > 20) {
    duration = (UsensorDist-20) * 95 + 100;  
  
  } else if (UsensorDist <20) {
    duration = 100;
  
  } else if (UsensorDist > 40) {
    duration = 2000;
